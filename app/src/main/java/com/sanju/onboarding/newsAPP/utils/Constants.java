package com.sanju.onboarding.newsAPP.utils;
...
public class Constants {
    ...
    /** API Key */
    public static final String API_KEY = "c46d4ebf-6057-47b9-91a4-300711ea048c"; // Use your API Key when API rate limit exceeded
